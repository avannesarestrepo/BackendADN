...
public class CustomNamedParameterJdbcTemplate {
	...
	public Long crear(MapSqlParameterSource sqlParameterSource,String sql, String primaryKey) {
		KeyHolder keyHolder = new GeneratedKeyHolder();
		this.namedParameterJdbcTemplate.update(sql, sqlParameterSource,keyHolder,new String[] { primaryKey });
		return keyHolder.getKey().longValue();
	}
